...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            # Process line by stripping the newline from the line
            line = line.rstrip()

            # Add dogname(line) to dognames_dic if it doesn't already exist 
            # in the dognames_dic dictionary
            if line not in dognames_dic:
                dognames_dic[line] = 1

            # Reads in the next line in the file to be processed with a while loop
